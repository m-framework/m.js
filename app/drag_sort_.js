...
m.fn.drag_sort = function() {
    ...
    var
        ...
        enter = function(e) {
            ...
            //if (closest_draggable.find('[data-m-action="drag_sort"]').length > 0) {
            //    prev_container = container;
            //    container = closest_draggable.find('[data-m-action="drag_sort"]');
            //}
        ...
        leave = function(e) {
            ...
            //if (closest_draggable.find('[data-m-action="drag_sort"]').length > 0 && prev_container !== null) {
